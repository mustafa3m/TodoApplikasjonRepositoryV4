    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Call the clinic and book a time for the dental check-up", false, "Schedule dentist appointment" },
                    { 2, 2, "Research trails and prepare gear for a Saturday hike", true, "Plan weekend hike" }
                });
